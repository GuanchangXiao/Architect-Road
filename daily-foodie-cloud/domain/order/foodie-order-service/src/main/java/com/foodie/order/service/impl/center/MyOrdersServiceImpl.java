...
import com.foodie.order.mapper.OrdersMapperCustom;
import com.foodie.order.pojo.OrderStatus;
import com.foodie.order.pojo.Orders;
import com.foodie.order.pojo.vo.MyOrdersVO;
...
public class MyOrdersServiceImpl extends BaseService implements MyOrdersService {
    ...
    public JSONResult checkUserOrder(String userId, String orderId) {
        ...
        return  orders != null ? JSONResult.ok(orders) : JSONResult.errorMsg("订单不存在！！");
    }
}
